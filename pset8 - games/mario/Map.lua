...
function Map:init()
    ...
    while x < self.mapWidth do
        ...
        if x == self.mapWidth - 5 then
            for i = 1, 5 do
                for b = 0, i do
                    self:setTile(x - 5 + i, self.mapHeight / 2 - b, TILE_BRICK)
                end
            ...
            self:setTile(x + 1, self.mapHeight / 2 - 3, FLAG)
...
function Map:collisionFlag(tile)
    -- define our winner tiles
    local collidables = {
        FLAG, POLE_BOTTOM, POLE_MIDDLE, POLE_TOP
    }
